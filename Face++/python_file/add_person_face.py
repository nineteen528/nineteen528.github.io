...
face = api.detection.detect(img =facepp.File('image/jack_cheng/6.jpg'))
...
res= api.person.add_face(api_key =API_KEY, api_secret = API_SECRET,person_name="成龙",face_id = face_id)
print_result(" ",res)
